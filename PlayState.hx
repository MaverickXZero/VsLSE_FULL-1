	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'schoolEvil': //Week 6 - Thorns
                ...
                case 'garage': //MOD gameover thingy
				...
				GameOverSubstate.characterName = 'plse_sing';
	...
	public function triggerEventNote(eventName:String, value1:String, value2:String) {
		switch(eventName) {
            ...
            case 'Snowing':
                ...
                var snowing:FlxEmitter;

                snowing = new FlxEmitter(-500, -450);            
        
                for (i in 0...1000)                                         //  load'er up                                  
                {
                    ...
                    p2.makeGraphic(6, 6, FlxColor.WHITE);
                    p3.makeGraphic(12, 12, FlxColor.WHITE);
                    snowing.add(p);
                    snowing.add(p2);
                    snowing.add(p3);
                }
                ...
                if (value == 1) {
                snowing.width = 2500;                                       // cover the screen
                snowing.launchMode = CIRCLE;
                snowing.velocity.set(-250, -700, 800, 1800);     
                snowing.lifespan.set(0);
                add(snowing);
                snowing.start(true, .05);                                   // don't be too fast and run out please
                } else {
                    snowing.kill();
                }
            ...
            case 'Blizzard':
                ...
                var blizzardT:FlxEmitter;
                var blizzardR:FlxEmitter;

                blizzardT = new FlxEmitter(-500, -450);
                blizzardR = new FlxEmitter(2500, -250);            
                ...
                if (value == 1) {
                blizzardT.width = 2500;                            
                blizzardT.launchMode = CIRCLE;
                blizzardT.acceleration.start.max.y = FlxG.random.int(-500, -8000);
                blizzardT.acceleration.end.min.y = FlxG.random.int(-1200, -1600);    
                blizzardT.acceleration.start.max.y = FlxG.random.int(800, 1000);
                blizzardT.acceleration.end.min.y = FlxG.random.int(1200, 1600);    
                blizzardT.lifespan.set(0);
                add(blizzardT);
                
                blizzardR.height = FlxG.height;                            
                blizzardR.launchMode = CIRCLE;
                blizzardR.acceleration.start.max.x = FlxG.random.int(-500, -8000);
                blizzardR.acceleration.end.min.x = FlxG.random.int(-1200, -1600);    
                blizzardR.acceleration.start.max.y = FlxG.random.int(800, 1000);
                blizzardR.acceleration.end.min.y = FlxG.random.int(1200, 1600);    
                blizzardR.lifespan.set(0);
                add(blizzardR);
                
                //blizzardT.start(true);
                blizzardR.start(true);                             
                } else {
                    blizzardR.kill();
                    blizzardT.kill();
                }
